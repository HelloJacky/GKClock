...
@property (nonatomic, assign) CGFloat hourHandWidth;            //时针宽度

@property (nonatomic, strong) UIColor *minuteHandColor;         //分针颜色
@property (nonatomic, assign) CGFloat minuteHandWidth;          //分针宽度

@property (nonatomic, strong) UIColor *secondHandColor;         //秒针颜色
@property (nonatomic, assign) CGFloat secondHandWidth;          //秒针宽度
...
@property (nonatomic, assign) CGFloat centerPointRadius;        //中心点的半径
